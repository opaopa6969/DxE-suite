...
const CHARACTER_COVERAGE: Record<string, Partial<ThemeRequirements>> = {
  ...
  chr_kinpachi: { needs_user_empathy: 0.8, needs_assumption_check: 0.5 },
  ...
  chr_ukyo: { needs_quality_focus: 0.8, needs_assumption_check: 0.7 },
  chr_socrates: { needs_assumption_check: 0.9, needs_bold_vision: 0.5 },
};
